...
export default function FooterMenu() {
    return (
        <div className="px-6 py-12 bg-lightblack ">
                    ...
                    <div className="flex space-x-3">
                        ...
                        <Link to="/">
                            <svg
                                ...
                                fill="currentColor"
                                className="text-lightgray w-6 bg-transparent transition-all delay-200 duration-200 ease-in-out hover:text-slate-500 lg:w-5"
                                viewBox="0 0 16 16"
                            >
            ...
            <div className="border-t border-solid border-divider pt-8">
                <p className="text-lightgray text-sm text-center">
                    Copyright ©<Link to="/">Moviearo.</Link> All rights
                    reserved.
                </p>
            </div>
        </div>
